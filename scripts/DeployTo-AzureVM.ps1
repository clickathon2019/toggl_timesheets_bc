...
$templateUri = 'https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/101-aci-dynamicsnav/azuredeploy.json'
...
$Parameters.Add("navRelease", $imageversion.containerImage)
$Parameters.Add("adminPassword", $credential.Password)
